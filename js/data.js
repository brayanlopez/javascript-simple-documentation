export const documentData = [
  ...
  {
    id: "Que_deberia_saber",
    title: "Que deberia saber",
    content: `
    <p>Esta guia asume que tienes los siguientes conocimientos básicos</p>
    <ul>
      <li>
        Un entendimiento general de internet y el World Wide Web (WWW)
      </li>
      <li>
        Buen conocimiento trabajando con HyperText Markup Language(HTML)
      </li>
      <li>Alguna experiencia programando. Si eres nuevo programando, trata alguno de los siguientes tutoriales.</li>
    </ul>`,
  },
  {
    id: "javascript_y_java",
    title: "JavaScript y Java",
    content: `
    <p>
  ...
  },
  {
    ...
    <p>El septimo objeto es un objeto.</p>
    <p>
